...
workflow DINOFLOW {
    ...
    ch_multiqc_files = ch_multiqc_files.mix(STARSOLO.out.log_final.collect{it[1]}.ifEmpty([]))
    ch_multiqc_files = ch_multiqc_files.mix(STARSOLO.out.summary.collect{it[1]}.ifEmpty([]))
